    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 pb-12">
      <section className="rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <p className="mt-3 text-muted-foreground">
          Please enter your unique invite code to view your event details and RSVP.<br />If you have any questions, email us at: <a className={venueMapLinkClasses} href="mailto:rsvp@spillard.io?subject=Question%20About%20RSVP">rsvp@spillard.io</a>
        </p>
      </section>
